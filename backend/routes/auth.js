...
router.post('/register', [
  ...
  body('role').optional().isIn(['user', 'artisan']).withMessage('Invalid role')
], async (req, res) => {
  try {
    ...
    // If user is registering as artisan, create artisan profile
    if (role === 'artisan') {
      await Artisan.create({
        user: user._id,
        bio: 'New artisan on the platform',
        specialty: 'General',
        location: {
...
router.get('/me', protect, async (req, res) => {
  try {
    ...
    // If user is artisan, populate artisan profile
